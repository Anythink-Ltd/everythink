          ...
          {imageDataList[index] && (
            <div className="relative">
              ...
              <button
                ...
                className="absolute -top-1 -right-1 z-10 bg-black rounded-full w-5 h-5 shadow-md hover:bg-zinc-900 transition-colors flex items-center justify-center"
              >
                <div className="i-ph:x w-3 h-3 text-zinc-200" />
              </button>
