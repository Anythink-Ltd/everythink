                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-200 dark:border-zinc-700">
                  <div className="flex items-center space-x-4">
                    {(activeTab || showTabManagement) && (
                      ...
                      >
                        <div className="i-ph:arrow-left w-4 h-4 text-zinc-500 dark:text-zinc-400 group-hover:text-orange-500 transition-colors" />
                      </button>
                    )}
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    >
                      <div className="i-ph:x w-4 h-4 text-zinc-500 dark:text-zinc-400 group-hover:text-orange-500 transition-colors" />
                    </button>
                  </div>
                </div>
