                  ...
                  <div className="p-2">
                    <div className="relative mx-2 mb-2">
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-1.5 text-sm rounded-lg bg-bolt-elements-background-depth-1 border border-bolt-elements-borderColor focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                      />
    ...
    return (
      chatStarted && (
        <div className="w-full h-full">
          <div className="w-full h-full px-2 lg:px-4 py-2">
